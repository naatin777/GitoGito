...
```bash
╭────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
│ Header ❯ fix: add login functionality [sk| (32/50)                                                              │
│        → [skip ci]                                                                                             │
│                                                                                                                │
│ Body   │                                                                                                       │
│                                                                                                                │
...
**Purpose**: Provide a single, most relevant suggestion directly in the input
field
...
The system analyzes the current input and cursor position to provide appropriate
suggestions:
...
Ensure long commit messages remain readable by wrapping at word boundaries
